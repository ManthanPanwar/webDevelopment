...
/*
Ans: Overconsumption of memory when using closure as everytime as those closed over variables are not garbage
...
Garbage collector : Program in JS engine or browser that frees up unused memory. In highlevel languages like C++ garbage collection is left to the programmer, but in JS engine its done implicitly
 */
function a() {
  var x = 0;
  return function b() {
